 ...
 * 
 * Disassembly of DSDT.dat, Sun Jan 10 18:58:51 2021
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000D850 (55376)
 *     Revision         0x02
 *     Checksum         0xC1
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
 ...
 */
DefinitionBlock ("DSDT.aml", "DSDT", 2, "ALASKA", "A M I", 0x00003071)
{
    /*
    ...
    External (_SB_.PCI0.P0PA, UnknownObj)
    External (_SB_.PCI0.P0PB, UnknownObj)
    ...
    External (_SB_.PCI0.P0PA.HPME, MethodObj)    // Warning: Unresolved method, guessing 0 arguments
    External (_SB_.PCI0.P0PB.HPME, MethodObj)    // Warning: Unresolved method, guessing 0 arguments
                ...
                Device (H_EC)
        {
            ...
            Device (BAT2)
            {
                ...
                Device (HPET)
                {
                    ...
                    Name (_CID, EisaId ("PNP0C01"))  // _UID: Unique ID
                    Name (BUF0, ResourceTemplate ()
                    {
                ...
                Device (MVL1)
                {
                    ...
                    Device (IDE0)
                    {
                        ...
                        Method (_GTM, 0, NotSerialized)  // _GTM: Get Timing Mode
                        {
                            ...
                            If (LAnd (FLGP, One))
                            {
                                If (LNot (MULT))
                                {
                                    If (LAnd (CAB0, SWAP))
                                    {
                                        Store (0x02, DMA0) /* \_SB_.PCI0.RP05.MVL1.DMA0 */
                                    }
                                }
                            ...
                            If (LAnd (FLGP, 0x04))
                            {
                                If (LAnd (CAB0, SWAP))
                                {
                                    Store (0x02, DMA1) /* \_SB_.PCI0.RP05.MVL1.DMA1 */
                                }
                            ...
                            Store (Local0, GTM0) /* \_SB_.PCI0.RP05.MVL1.GTM0 */
                            Store (Local1, GTM1) /* \_SB_.PCI0.RP05.MVL1.GTM1 */
                            Store (Local2, GTM2) /* \_SB_.PCI0.RP05.MVL1.GTM2 */
                            Store (Local3, GTM3) /* \_SB_.PCI0.RP05.MVL1.GTM3 */
                            Store (Local4, GTM4) /* \_SB_.PCI0.RP05.MVL1.GTM4 */
                            Return (IDEB) /* \_SB_.PCI0.RP05.MVL1.IDEB */
                        }

                        Method (_STM, 3, NotSerialized)  // _STM: Set Timing Mode
                        {
                            Store (Arg0, IDEB) /* \_SB_.PCI0.RP05.MVL1.IDEB */
                            Store (GTM0, Local0)
                            Store (GTM1, Local1)
                            Store (GTM2, Local2)
                            Store (GTM3, Local3)
                            Store (GTM4, Local4)
                            Store (Local4, FLGP) /* \_SB_.PCI0.RP05.MVL1.FLGP */
                            If (LAnd (LNotEqual (Local0, 0xFFFFFFFF), LNotEqual (Local0, Zero)))
                            {
                                Store (Match (PIOT, MEQ, Local0, MTR, Zero, Zero), PIO0) /* \_SB_.PCI0.RP05.MVL1.PIO0 */
                            }
                            ...
                            If (LAnd (LNotEqual (Local1, 0xFFFFFFFF), LNotEqual (Local1, Zero)))
                            {
                                If (LAnd (FLGP, One))
                                {
                                    Store (Match (UDMA, MEQ, Local1, MTR, Zero, Zero), DMA0) /* \_SB_.PCI0.RP05.MVL1.DMA0 */
                                }
                                Else
                                {
                                    Store (Match (MDMA, MEQ, Local1, MTR, Zero, Zero), MDA0) /* \_SB_.PCI0.RP05.MVL1.MDA0 */
                                }
                            }

                            If (LAnd (LNotEqual (Local2, 0xFFFFFFFF), LNotEqual (Local2, Zero)))
                            {
                                Store (Match (PIOT, MEQ, Local2, MTR, Zero, Zero), PIO1) /* \_SB_.PCI0.RP05.MVL1.PIO1 */
                            }
                            ...
                            If (LAnd (LNotEqual (Local3, 0xFFFFFFFF), LNotEqual (Local3, Zero)))
                            {
                                If (LAnd (FLGP, 0x04))
                                {
                                    Store (Match (UDMA, MEQ, Local3, MTR, Zero, Zero), DMA1) /* \_SB_.PCI0.RP05.MVL1.DMA1 */
                                }
                                Else
                                {
                                    Store (Match (MDMA, MEQ, Local3, MTR, Zero, Zero), MDA1) /* \_SB_.PCI0.RP05.MVL1.MDA1 */
                                }
                            }
                        }
                        ...
                        Device (DRV0)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                Store (PIO0, PIOM) /* \_SB_.PCI0.RP05.MVL1.IDE0.DRV0._GTF.PIOM */
                                Or (PIOM, 0x08, PIOM) /* \_SB_.PCI0.RP05.MVL1.IDE0.DRV0._GTF.PIOM */
                                If (LAnd (FLGP, One))
                                {
                                    Store (DMA0, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE0.DRV0._GTF.DMAM */
                                    Or (DMAM, 0x40, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE0.DRV0._GTF.DMAM */
                                }
                                Else
                                {
                                    Store (MDA0, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE0.DRV0._GTF.DMAM */
                                    Or (DMAM, 0x20, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE0.DRV0._GTF.DMAM */
                                }
                        ...
                        Device (DRV1)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                CreateByteField (Local0, One, PIOM)
                                CreateByteField (Local1, One, DMAM)
                                Store (PIO1, PIOM) /* \_SB_.PCI0.RP05.MVL1.IDE0.DRV1._GTF.PIOM */
                                Or (PIOM, 0x08, PIOM) /* \_SB_.PCI0.RP05.MVL1.IDE0.DRV1._GTF.PIOM */
                                If (LAnd (FLGP, 0x04))
                                {
                                    Store (DMA1, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE0.DRV1._GTF.DMAM */
                                    Or (DMAM, 0x40, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE0.DRV1._GTF.DMAM */
                                }
                                Else
                                {
                                    Store (MDA1, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE0.DRV1._GTF.DMAM */
                                    Or (DMAM, 0x20, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE0.DRV1._GTF.DMAM */
                                }
                    ...
                    Device (IDE1)
                    {
                        ...
                        Method (_GTM, 0, NotSerialized)  // _GTM: Get Timing Mode
                        {
                            ...
                            If (LAnd (FLGS, One))
                            {
                                If (LNot (MULT))
                                {
                                    ...
                                    {
                                        Store (0x02, DMA2) /* \_SB_.PCI0.RP05.MVL1.DMA2 */
                                    }
                                }
                            ...
                            If (LAnd (FLGS, 0x04))
                            {
                                If (LAnd (CAB0, LNot (SWAP)))
                                {
                                    Store (0x02, DMA3) /* \_SB_.PCI0.RP05.MVL1.DMA3 */
                                }
                        ...
                        Method (_STM, 3, NotSerialized)  // _STM: Set Timing Mode
                        {
                            ...
                            Store (GTM3, Local3)
                            Store (GTM4, Local4)
                            Store (Local4, FLGS) /* \_SB_.PCI0.RP05.MVL1.FLGS */
                            If (LAnd (LNotEqual (Local0, 0xFFFFFFFF), LNotEqual (Local0, Zero)))
                            {
                                Store (Match (PIOT, MEQ, Local0, MTR, Zero, Zero), PIO2) /* \_SB_.PCI0.RP05.MVL1.PIO2 */
                            }
                            ...
                            If (LAnd (LNotEqual (Local1, 0xFFFFFFFF), LNotEqual (Local1, Zero)))
                            {
                                If (LAnd (FLGS, One))
                                {
                                    Store (Match (UDMA, MEQ, Local1, MTR, Zero, Zero), DMA2) /* \_SB_.PCI0.RP05.MVL1.DMA2 */
                                }
                                Else
                                {
                                    Store (Match (MDMA, MEQ, Local1, MTR, Zero, Zero), MDA2) /* \_SB_.PCI0.RP05.MVL1.MDA2 */
                                }
                            }

                            If (LAnd (LNotEqual (Local2, 0xFFFFFFFF), LNotEqual (Local2, Zero)))
                            {
                                Store (Match (PIOT, MEQ, Local2, MTR, Zero, Zero), PIO3) /* \_SB_.PCI0.RP05.MVL1.PIO3 */
                            }
                            ...
                            If (LAnd (LNotEqual (Local3, 0xFFFFFFFF), LNotEqual (Local3, Zero)))
                            {
                                If (LAnd (FLGS, 0x04))
                                {
                                    Store (Match (UDMA, MEQ, Local3, MTR, Zero, Zero), DMA3) /* \_SB_.PCI0.RP05.MVL1.DMA3 */
                                }
                                Else
                                {
                                    Store (Match (MDMA, MEQ, Local3, MTR, Zero, Zero), MDA3) /* \_SB_.PCI0.RP05.MVL1.MDA3 */
                                }
                            }
                        }
                        ...
                        Device (DRV0)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                CreateByteField (Local0, One, PIOM)
                                CreateByteField (Local1, One, DMAM)
                                Store (PIO2, PIOM) /* \_SB_.PCI0.RP05.MVL1.IDE1.DRV0._GTF.PIOM */
                                Or (PIOM, 0x08, PIOM) /* \_SB_.PCI0.RP05.MVL1.IDE1.DRV0._GTF.PIOM */
                                If (LAnd (FLGS, One))
                                {
                                    Store (DMA2, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE1.DRV0._GTF.DMAM */
                                    Or (DMAM, 0x40, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE1.DRV0._GTF.DMAM */
                                }
                                Else
                                {
                                    Store (MDA2, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE1.DRV0._GTF.DMAM */
                                    Or (DMAM, 0x20, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE1.DRV0._GTF.DMAM */
                                }
                        ...
                        Device (DRV1)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                CreateByteField (Local0, One, PIOM)
                                CreateByteField (Local1, One, DMAM)
                                Store (PIO3, PIOM) /* \_SB_.PCI0.RP05.MVL1.IDE1.DRV1._GTF.PIOM */
                                Or (PIOM, 0x08, PIOM) /* \_SB_.PCI0.RP05.MVL1.IDE1.DRV1._GTF.PIOM */
                                If (LAnd (FLGS, 0x04))
                                {
                                    Store (DMA3, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE1.DRV1._GTF.DMAM */
                                    Or (DMAM, 0x40, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE1.DRV1._GTF.DMAM */
                                }
                                Else
                                {
                                    Store (MDA3, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE1.DRV1._GTF.DMAM */
                                    Or (DMAM, 0x20, DMAM) /* \_SB_.PCI0.RP05.MVL1.IDE1.DRV1._GTF.DMAM */
                                }
                    ...
                    Device (IDE0)
                    {
                        ...
                        Method (_GTM, 0, NotSerialized)  // _GTM: Get Timing Mode
                        {
                            ...
                            If (LAnd (FLGP, One))
                            {
                                If (LAnd (CAB0, SWAP))
                                {
                                    Store (0x02, DMA0) /* \_SB_.PCI0.RP05.MVL2.DMA0 */
                                }
                            ...
                            If (LAnd (FLGP, 0x04))
                            {
                                If (LAnd (CAB0, SWAP))
                                {
                                    Store (0x02, DMA1) /* \_SB_.PCI0.RP05.MVL2.DMA1 */
                                }
                            ...
                            Store (Local0, GTM0) /* \_SB_.PCI0.RP05.MVL2.GTM0 */
                            Store (Local1, GTM1) /* \_SB_.PCI0.RP05.MVL2.GTM1 */
                            Store (Local2, GTM2) /* \_SB_.PCI0.RP05.MVL2.GTM2 */
                            Store (Local3, GTM3) /* \_SB_.PCI0.RP05.MVL2.GTM3 */
                            Store (Local4, GTM4) /* \_SB_.PCI0.RP05.MVL2.GTM4 */
                            Return (IDEB) /* \_SB_.PCI0.RP05.MVL2.IDEB */
                        }

                        Method (_STM, 3, NotSerialized)  // _STM: Set Timing Mode
                        {
                            Store (Arg0, IDEB) /* \_SB_.PCI0.RP05.MVL2.IDEB */
                            Store (GTM0, Local0)
                            Store (GTM1, Local1)
                            Store (GTM2, Local2)
                            Store (GTM3, Local3)
                            Store (GTM4, Local4)
                            Store (Local4, FLGP) /* \_SB_.PCI0.RP05.MVL2.FLGP */
                            If (LAnd (LNotEqual (Local0, 0xFFFFFFFF), LNotEqual (Local0, Zero)))
                            {
                                Store (Match (PIOT, MEQ, Local0, MTR, Zero, Zero), PIO0) /* \_SB_.PCI0.RP05.MVL2.PIO0 */
                            }
                            ...
                            If (LAnd (LNotEqual (Local1, 0xFFFFFFFF), LNotEqual (Local1, Zero)))
                            {
                                If (LAnd (FLGP, One))
                                {
                                    Store (Match (UDMA, MEQ, Local1, MTR, Zero, Zero), DMA0) /* \_SB_.PCI0.RP05.MVL2.DMA0 */
                                }
                                Else
                                {
                                    Store (Match (MDMA, MEQ, Local1, MTR, Zero, Zero), MDA0) /* \_SB_.PCI0.RP05.MVL2.MDA0 */
                                }
                            }

                            If (LAnd (LNotEqual (Local2, 0xFFFFFFFF), LNotEqual (Local2, Zero)))
                            {
                                Store (Match (PIOT, MEQ, Local2, MTR, Zero, Zero), PIO1) /* \_SB_.PCI0.RP05.MVL2.PIO1 */
                            }
                            ...
                            If (LAnd (LNotEqual (Local3, 0xFFFFFFFF), LNotEqual (Local3, Zero)))
                            {
                                If (LAnd (FLGP, 0x04))
                                {
                                    Store (Match (UDMA, MEQ, Local3, MTR, Zero, Zero), DMA1) /* \_SB_.PCI0.RP05.MVL2.DMA1 */
                                }
                                Else
                                {
                                    Store (Match (MDMA, MEQ, Local3, MTR, Zero, Zero), MDA1) /* \_SB_.PCI0.RP05.MVL2.MDA1 */
                                }
                            }
                        }
                        ...
                        Device (DRV0)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                CreateByteField (Local0, One, PIOM)
                                CreateByteField (Local1, One, DMAM)
                                Store (PIO0, PIOM) /* \_SB_.PCI0.RP05.MVL2.IDE0.DRV0._GTF.PIOM */
                                Or (PIOM, 0x08, PIOM) /* \_SB_.PCI0.RP05.MVL2.IDE0.DRV0._GTF.PIOM */
                                If (LAnd (FLGP, One))
                                {
                                    Store (DMA0, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE0.DRV0._GTF.DMAM */
                                    Or (DMAM, 0x40, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE0.DRV0._GTF.DMAM */
                                }
                                Else
                                {
                                    Store (MDA0, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE0.DRV0._GTF.DMAM */
                                    Or (DMAM, 0x20, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE0.DRV0._GTF.DMAM */
                                }
                        ...
                        Device (DRV1)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                CreateByteField (Local0, One, PIOM)
                                CreateByteField (Local1, One, DMAM)
                                Store (PIO1, PIOM) /* \_SB_.PCI0.RP05.MVL2.IDE0.DRV1._GTF.PIOM */
                                Or (PIOM, 0x08, PIOM) /* \_SB_.PCI0.RP05.MVL2.IDE0.DRV1._GTF.PIOM */
                                If (LAnd (FLGP, 0x04))
                                {
                                    Store (DMA1, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE0.DRV1._GTF.DMAM */
                                    Or (DMAM, 0x40, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE0.DRV1._GTF.DMAM */
                                }
                                Else
                                {
                                    Store (MDA1, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE0.DRV1._GTF.DMAM */
                                    Or (DMAM, 0x20, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE0.DRV1._GTF.DMAM */
                                }
                    ...
                    Device (IDE1)
                    {
                        ...
                        Method (_GTM, 0, NotSerialized)  // _GTM: Get Timing Mode
                        {
                            ...
                            If (LAnd (FLGS, One))
                            {
                                If (LAnd (CAB0, LNot (SWAP)))
                                {
                                    Store (0x02, DMA2) /* \_SB_.PCI0.RP05.MVL2.DMA2 */
                                }
                            ...
                            If (LAnd (FLGS, 0x04))
                            {
                                If (LAnd (CAB0, LNot (SWAP)))
                                {
                                    Store (0x02, DMA3) /* \_SB_.PCI0.RP05.MVL2.DMA3 */
                                }
                        ...
                        Method (_STM, 3, NotSerialized)  // _STM: Set Timing Mode
                        {
                            ...
                            Store (GTM3, Local3)
                            Store (GTM4, Local4)
                            Store (Local4, FLGS) /* \_SB_.PCI0.RP05.MVL2.FLGS */
                            If (LAnd (LNotEqual (Local0, 0xFFFFFFFF), LNotEqual (Local0, Zero)))
                            {
                                Store (Match (PIOT, MEQ, Local0, MTR, Zero, Zero), PIO2) /* \_SB_.PCI0.RP05.MVL2.PIO2 */
                            }
                            ...
                            If (LAnd (LNotEqual (Local1, 0xFFFFFFFF), LNotEqual (Local1, Zero)))
                            {
                                If (LAnd (FLGS, One))
                                {
                                    Store (Match (UDMA, MEQ, Local1, MTR, Zero, Zero), DMA2) /* \_SB_.PCI0.RP05.MVL2.DMA2 */
                                }
                                Else
                                {
                                    Store (Match (MDMA, MEQ, Local1, MTR, Zero, Zero), MDA2) /* \_SB_.PCI0.RP05.MVL2.MDA2 */
                                }
                            }

                            If (LAnd (LNotEqual (Local2, 0xFFFFFFFF), LNotEqual (Local2, Zero)))
                            {
                                Store (Match (PIOT, MEQ, Local2, MTR, Zero, Zero), PIO3) /* \_SB_.PCI0.RP05.MVL2.PIO3 */
                            }
                            ...
                            If (LAnd (LNotEqual (Local3, 0xFFFFFFFF), LNotEqual (Local3, Zero)))
                            {
                                If (LAnd (FLGS, 0x04))
                                {
                                    Store (Match (UDMA, MEQ, Local3, MTR, Zero, Zero), DMA3) /* \_SB_.PCI0.RP05.MVL2.DMA3 */
                                }
                                Else
                                {
                                    Store (Match (MDMA, MEQ, Local3, MTR, Zero, Zero), MDA3) /* \_SB_.PCI0.RP05.MVL2.MDA3 */
                                }
                            }
                        }
                        ...
                        Device (DRV0)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                CreateByteField (Local0, One, PIOM)
                                CreateByteField (Local1, One, DMAM)
                                Store (PIO2, PIOM) /* \_SB_.PCI0.RP05.MVL2.IDE1.DRV0._GTF.PIOM */
                                Or (PIOM, 0x08, PIOM) /* \_SB_.PCI0.RP05.MVL2.IDE1.DRV0._GTF.PIOM */
                                If (LAnd (FLGS, One))
                                {
                                    Store (DMA2, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE1.DRV0._GTF.DMAM */
                                    Or (DMAM, 0x40, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE1.DRV0._GTF.DMAM */
                                }
                                Else
                                {
                                    Store (MDA2, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE1.DRV0._GTF.DMAM */
                                    Or (DMAM, 0x20, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE1.DRV0._GTF.DMAM */
                                }
                        ...
                        Device (DRV1)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                CreateByteField (Local0, One, PIOM)
                                CreateByteField (Local1, One, DMAM)
                                Store (PIO3, PIOM) /* \_SB_.PCI0.RP05.MVL2.IDE1.DRV1._GTF.PIOM */
                                Or (PIOM, 0x08, PIOM) /* \_SB_.PCI0.RP05.MVL2.IDE1.DRV1._GTF.PIOM */
                                If (LAnd (FLGS, 0x04))
                                {
                                    Store (DMA3, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE1.DRV1._GTF.DMAM */
                                    Or (DMAM, 0x40, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE1.DRV1._GTF.DMAM */
                                }
                                Else
                                {
                                    Store (MDA3, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE1.DRV1._GTF.DMAM */
                                    Or (DMAM, 0x20, DMAM) /* \_SB_.PCI0.RP05.MVL2.IDE1.DRV1._GTF.DMAM */
                                }
    ...
    Scope (_SB)
    {
        ...
        Device (PTMD)
        {
            ...
            {
                OperationRegion (GCAD, SystemMemory, 0xFFFF0000, 0x1234)
                Field (GCAD, ByteAcc, NoLock, Preserve)
                {
                    XBUF,   37280
                }

                Name (XTMP, Buffer (0x1234) {})
            ...
            {
                OperationRegion (GDAD, SystemMemory, 0xFFFF0000, 0x2000)
            ...
            Method (GXDV, 1, Serialized)
            {
                ...
                OperationRegion (PRFA, SystemMemory, 0xFFFF0000, 0x2000)
    ...
    Scope (_GPE)
    {
        ...
        Method (XL09, 0, NotSerialized)
        {
            ...
            {
                \_SB.PCI0.P0PA.HPME ()
                Notify (\_SB.PCI0.P0PA, 0x02) // Device Wake
            }

            If (LEqual (\_SB.PCI0.D1F2, One))
            {
                \_SB.PCI0.P0PB.HPME ()
                Notify (\_SB.PCI0.P0PB, 0x02) // Device Wake
            }
        }
